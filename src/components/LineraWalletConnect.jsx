/**
 * Linera Wallet Connect Component
 * 
 * Provides native Linera wallet integration:
 * 1. CheCko Wallet (respeer-ai/linera-wallet) - Browser extension
 * 2. @linera/client SDK - Direct chain interaction
 * 3. Auto-creates wallet via faucet on Conway testnet
 * 
 * References:
  ...
  useEffect(() => {
    const checkConnection = async () => {
      ...
      if (lineraChainService.isConnected()) {
        ...
        setWalletInfo(lineraChainService._getConnectionInfo());
            ...
            <div className="p-4 border-b border-gray-700">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="px-2 py-0.5 bg-emerald-500/20 text-emerald-400 text-xs rounded-full">
                  {walletInfo.mode === 'sdk' ? 'On-Chain' : 'GraphQL'}
                </span>
              </div>
            ...
            <div className="p-2">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500">Request from Conway faucet</div>
                </div>
              </button>
